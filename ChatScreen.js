...
const messages = [
  { id: "1", name: "Media Box", message: "Zing MP3: Lắng nghe Negav...", time: "", avatar: require("./assets/man.png")  },
  { id: "2", name: "Hiếu Lai", message: "cho xin UML của m đi", time: "2 giờ", avatar: require("./assets/man.png") },
  { id: "3", name: "TTDT_NHÓM 1_TH", message: "Nhắc hẹn: deadline đi...", time: "5 giờ", avatar: require("./assets/man.png") },
  { id: "4", name: "Hồ Mờ Hồ Và Những Người Bạn", message: "Hồ Minh Hậu: T về LA", time: "6 giờ", avatar: require("./assets/man.png")},
];
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity style={{ flexDirection: "row", alignItems: "center", padding: 15, backgroundColor: "white", marginBottom: 2, height: ITEM_HEIGHT }}>
              <Image source={item.avatar} style={{ width: AVATAR_SIZE, height: AVATAR_SIZE, borderRadius: AVATAR_SIZE / 2, marginRight: 15 }} />
              <View style={{ flex: 1 }}>
